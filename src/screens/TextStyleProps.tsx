      ...
      <Text
        style={[
          styles.paragraph,
          {
            ...
            fontWeight: fontWeightIdx[fontWeightIdx],
            lineHeight,
            textAlign: textAlignments[textAlignIdx],
            textDecorationLine: textDecorationLineIdx[textDecorationLineIdx],
...
const CustomSwitch = ({ label, handleValueChange, value }:{ label: any, handleValueChange: any, value: any }): any => {
  return (
    <>
...
const CustomPicker = ({ label, data, currentIndex, onSelected }:{ label: any, data: any, currentIndex: any, onSelected: any }): any => {
  return (
    <>
      <Text style={styles.title}>{label}</Text>
      <View style={styles.wrapperHorizontal}>
